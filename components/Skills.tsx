...
const Skills: React.FC = () => {
  return (
    <section className="py-32 px-4 bg-darker relative overflow-hidden scroll-mt-20" id="skills">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-slate-800 pb-6"
        >
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SKILLS.map((category, index) => {
            ...
            return (
              ...
              >
                {/* Card Container */}
                <div className="h-full bg-slate-900/80 backdrop-blur-sm border border-slate-800 rounded-xl p-6 transition-all duration-300 hover:border-primary/50 hover:shadow-[0_0_30px_rgba(14,165,233,0.1)]">
                  
                  {/* Header */}
                  <div className="flex items-center gap-4 mb-6 pb-4 border-b border-slate-800 group-hover:border-primary/30 transition-colors">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-slate-200 font-mono">{category.name}</h3>
